  ...
  return (
    <div className="container mx-auto p-4 max-w-6xl">
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-grow space-y-4">
          {groupedItems.map((item) => (
            <div
              ...
              className="p-4 sm:p-6 border rounded-xl shadow-sm hover:shadow-md transition-all duration-300 bg-white group">
        ...
        <div className="lg:w-96 bg-white p-4 sm:p-6 rounded-xl shadow-sm h-fit sticky top-4">
