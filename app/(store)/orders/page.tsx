                                            ...
                                            <div className='bg-gray-50 rounded-lg p-4'>
                                                <div className='flex items-center justify-between mb-4'>
                                                    ...
                                                    <div className='text-right'>
                                                        ...
                                                        <span className={`mt-1 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${order.status === "paid" ? "bg-green-100 text-green-800" :
                                                ...
                                                <div className='grid grid-cols-2 gap-4'>
                                                    <div>
                                                        ...
                                                        <p className='mt-1 text-sm text-gray-900'>
                                                              {order.orderDate ? <LocalDate isoDate={order.orderDate} /> : "N/A"}
                                                        </p>
                                                    </div>
                                                    <div>
