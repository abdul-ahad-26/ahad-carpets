        ...
        <Popover open={open} onOpenChange={setOpen} >
            ...
            <PopoverTrigger asChild>
                <Button variant="outline"
                    role="combobox"
                    aria-expanded={open}
                    className='w-full max-w-full relative flex justify-center  sm:flex-none items-center space-x-2  font-bold py-2 px-4 bg-[#1a3fa6] text-white rounded-full hover:bg-[#2563eb] hover:text-white'>
